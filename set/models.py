...
class SetInfo(models.Model):
    bricklink_name = models.CharField(max_length=99999999, null=True, blank=True)
    lego_name = models.CharField(max_length=99999999, null=True, blank=True)
    brickeconomy_name = models.CharField(max_length=99999999, null=True, blank=True)
    bricksandminifigsanaheim_name = models.CharField(max_length=99999999, null=True, blank=True)
    ...
    weight = models.CharField(max_length=99999999, null=True, blank=True)
    dim = models.CharField(max_length=99999999, null=True, blank=True)
    parts = models.CharField(max_length=99999999, null=True, blank=True)
...
class Sellers(models.Model):
    ...
    set = models.ForeignKey(SetId, on_delete=models.CASCADE)
    name = models.CharField(max_length=99999999, null=True, blank=True)
    description = models.TextField(null=True, blank=True)
    condition = models.CharField(max_length=99999999, null=True, blank=True)
    country = models.CharField(max_length=99999999, null=True, blank=True)
    complete = models.CharField(max_length=99999999, null=True, blank=True)
    usd_price = models.FloatField(null=True, blank=True)
    real_price = models.CharField(max_length=99999999,null=True, blank=True)
    quantity = models.IntegerField(null=True, blank=True)
    buy_url = models.URLField(null=True, blank=True, max_length=900000)
    source = models.CharField(choices=SOURCES, max_length=99999999, db_index=True)
